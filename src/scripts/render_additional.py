...
with install_import_hook(
    ...
    from model.latentsplat_wrapper import ModelWrapper
...
def render(cfg_dict: DictConfig):
    ...
    encoder, encoder_visualizer = get_encoder(
        ...
        scale_factor=Fraction(1, cfg.model.gaussian_resolution_divisor),
    ...
    for batch in tqdm(dataset):
        ...
        output_path = output_dir / "render_additional" / scene / context_index_str
